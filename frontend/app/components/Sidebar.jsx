...
import { clearUser, selectAuth, selectRole } from '@/app/store/authSlice';
...
export default function Sidebar({ activeMode, onModeChange }) {
  ...
  // Get auth and role from Redux
  const auth = useSelector(selectAuth);              // export const selectAuth = (state) => state.auth.user
