...
class NodeBase(BaseModel):
    ...
    response: Optional[str] = Field(None, description="Optional response for the node")
...
class UserSignup(UserBase):
    ...
    role: Optional[str] = Field(default="user", description="User role: 'user' or 'admin' (admin creation requires authorization)")
